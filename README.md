...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-05 08:59`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a82b7a53-c208-430b-b510-56863401ff4a.git
$ cd a82b7a53-c208-430b-b510-56863401ff4a
```
